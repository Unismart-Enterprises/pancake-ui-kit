...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#22310a", backgroundDisabled: "#ed1d23", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#8fd129", tertiary: "#8fd129", text: "#8fd129", textDisabled: "#BDC2C4", textSubtle: "#8f80ba", borderColor: "#E9EAEB", card: "#1b2b03", inputSecondary: "#d7caec", gradients: {
